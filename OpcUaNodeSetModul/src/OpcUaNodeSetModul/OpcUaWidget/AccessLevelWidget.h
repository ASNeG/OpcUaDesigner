...
#ifndef __OpcUaNodeSet_AccessLevelWidget_h__
#define __OpcUaNodeSet_AccessLevelWidget_h__
...
namespace OpcUaNodeSet
{
	...
	class AccessLevelWidget
	: public QWidget
	{
		Q_OBJECT

	  public:
		AccessLevelWidget(QWidget* parent = 0);
		virtual ~AccessLevelWidget(void);
