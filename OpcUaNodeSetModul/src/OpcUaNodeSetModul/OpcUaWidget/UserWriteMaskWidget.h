...
#ifndef __OpcUaNodeSet_UserWriteMaskWidget_h__
#define __OpcUaNodeSet_UserWriteMaskWidget_h__
...
namespace OpcUaNodeSet
{
	...
	: public QWidget
	{
	  ...
	  public:
		UserWriteMaskWidget(QWidget* parent = 0);
		virtual ~UserWriteMaskWidget(void);
